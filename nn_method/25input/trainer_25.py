...
class NaiveTrainer:
    ...
    def trainer(self, dataset_path):
        ...
        # Save nn model
        model = torch.save(model.state_dict(), "nn_method/25input/result/my_baby_naive.pt")
...
class AttentionTrainer:
    ...
    def trainer(self, dataset_path):
        ...
        # Save nn model
        model = torch.save(model.state_dict(), "nn_method/25input/result/my_baby_attention.pt")

...
class HyperTune:
    ...
    def objective(self, trial):
        ...
        train_loader, valid_loader = self.get_dataset("dataset/NN/5p_5norm_target/dataset/train_dataset.csv", "dataset/NN/5p_5norm_target/dataset/validation_dataset.csv")
...
if __name__ == "__main__":
    ...
    study.optimize(tune.objective, n_trials=100, timeout=3600)

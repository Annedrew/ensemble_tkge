...
class NaiveTrainer:
    ...
    def trainer(self, dataset_path):
        ...
        for epoch in range(EPOCH):
            ...
            # if (epoch + 1) == 21:
            #     torch.save(model.state_dict(), "nn_method/5input/my_baby_naive_21.pt")
            # if (epoch + 1) == 81:
            #     torch.save(model.state_dict(), "nn_method/5input/my_baby_naive_81.pt")

        # Save nn model
        model = torch.save(model.state_dict(), "nn_method/5input/result/my_baby_naive.pt")
...
if __name__ == "__main__":
    ...
    # att_train.trainer("dataset/NN/5p_5w/dataset/train_dataset.csv")
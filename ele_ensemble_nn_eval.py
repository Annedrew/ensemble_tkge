...
if __name__ == "__main__":
    ...
    # best_weights = "nn_method/5input/result/prediction_naive_head.csv"
    # best_weights = "nn_method/5input/result/prediction_naive_relation.csv"
    # best_weights = "nn_method/5input/result/prediction_naive_tail.csv"
    # best_weights = "nn_method/5input/result/prediction_naive_time.csv"

    # best_weights = "nn_method/25input/result/prediction_naive_head.csv"
    # best_weights = "nn_method/25input/result/prediction_naive_relation.csv"
    # best_weights = "nn_method/25input/result/prediction_naive_tail.csv"
    best_weights = "nn_method/25input/result/prediction_naive_time.csv"
    # 这里是simu的分数，名称不一致罢了
    # sim_ranks_path = "dataset/ranks/sim_rank_head.json"
    # sim_ranks_path = "dataset/ranks/sim_rank_relation.json"
    # sim_ranks_path = "dataset/ranks/sim_rank_tail.json"
    sim_ranks_path = "dataset/ranks/sim_rank_time.json"
